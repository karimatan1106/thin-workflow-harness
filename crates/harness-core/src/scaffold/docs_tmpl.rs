...
//!
//! 設計指針:
//! - 全 .md は YAML frontmatter 必須 (doc-id / status / supersedes / tags /
//!   description / last-reviewed) ── agent が body を読まずに relevance 判定可能に。
...
3. frontmatter で `status: Accepted` / `supersedes: []` / `superseded-by: null`

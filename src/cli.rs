...
pub enum Command {
    ...
    FindSymbol { query: String, #[arg(long)] kind: Option<String>, #[arg(long)] root: Option<String>, #[arg(long, default_value = "text")] format: String, #[arg(long, default_value = "auto")] lang: String, #[arg(long)] daemon_port: Option<u16>, #[arg(long)] use_daemon: bool },
    ...
    Refs { qname: String, #[arg(long)] root: Option<String>, #[arg(long, default_value = "text")] format: String, #[arg(long, default_value = "auto")] lang: String, #[arg(long)] daemon_port: Option<u16>, #[arg(long)] use_daemon: bool },
    /// 指定 function の呼び出し元一覧。CKG layer 2 (多言語 LSP)。
    Callers { qname: String, #[arg(long)] root: Option<String>, #[arg(long, default_value = "text")] format: String, #[arg(long, default_value = "auto")] lang: String, #[arg(long)] daemon_port: Option<u16>, #[arg(long)] use_daemon: bool },
    /// refs/callers の transitive 閉包。CKG layer 2 (多言語 LSP)。
    Closure { qname: String, #[arg(long, default_value_t = 2)] depth: usize, #[arg(long, default_value = "in")] direction: String, #[arg(long)] root: Option<String>, #[arg(long, default_value = "text")] format: String, #[arg(long, default_value = "auto")] lang: String, #[arg(long)] daemon_port: Option<u16>, #[arg(long)] use_daemon: bool },
    /// 変更影響範囲評価。closure direction=in の薄いラッパ。CKG layer 2 (多言語 LSP)。
    ImpactedBy { qname: String, #[arg(long, default_value_t = 3)] depth: usize, #[arg(long)] root: Option<String>, #[arg(long, default_value = "text")] format: String, #[arg(long, default_value = "auto")] lang: String, #[arg(long)] daemon_port: Option<u16>, #[arg(long)] use_daemon: bool },
    /// 指定 symbol をテストしている test 関数一覧。CKG layer 2 (多言語 LSP)。
    TestedBy { qname: String, #[arg(long, default_value_t = 3)] depth: usize, #[arg(long)] root: Option<String>, #[arg(long, default_value = "text")] format: String, #[arg(long, default_value = "auto")] lang: String, #[arg(long)] daemon_port: Option<u16>, #[arg(long)] use_daemon: bool },
